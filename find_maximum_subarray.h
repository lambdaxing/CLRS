...
template <typename T>
T find_max_crossing_subarray(T* const A, unsigned low, unsigned mid,
                             unsigned high) {
  T sum{};
...
template <typename T>
T find_maximum_subarray(T* const A, unsigned low, unsigned high) {
...
template <typename T>
T find_maximum_subarray(T* const A, unsigned N) {
